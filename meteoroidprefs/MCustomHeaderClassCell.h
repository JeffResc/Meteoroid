...
@implementation MCustomHeaderCell
...
- (id)init {
       ...
       if (self) {
				 		...
				 		self.iconView = [[UIImageView alloc] initWithImage:[[UIImage alloc] initWithContentsOfFile:@"/Library/PreferenceBundles/meteoroidprefs.bundle/iconlarge.png"]];
            ...
            [self.headerLabel setText:@"Meteoroid"];
